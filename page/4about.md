...
<iframe src="https://githubbadge.appspot.com/haleshaw?s=1" style="border: 0;height: 142px;width: 200px;overflow: hidden;" frameBorder="0"></iframe>
...
* GitHub：[Gaohaoyang](https://github.com/HaleShaw)
...
* 2016.3-2016.4 进行了一次大的改版和重构，详见 [README](https://github.com/Haleshaw/haleshaw.github.io/blob/master/README.md) 和博文 [对这个 jekyll 博客主题的改版和重构](http://haleshaw.github.io/2016/03/12/jekyll-theme-version-2.0/)
* 2019.5 通过博客模板，初步搭建成功。
